		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comviatrismaterialmaster-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comviatrismaterialmaster-display": {
								"semanticObject": "comviatrismaterialmaster",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.viatris.materialmaster",
									"url": sap.ui.require.toUrl("com/viatris/materialmaster")
								}
							}
						}
					}
